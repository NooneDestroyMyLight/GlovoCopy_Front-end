...
const StoreCartMobile: FC<PageStoreCartMobileProps> = memo(
  ({ totalCartCost, totalProductCount, onMessageClick }) => {
    const arrInstallingEl: ITextIncertType[] = [
      {
        component: (
          <strong>
    ...
    const messsage = funTextIncert(CART_ITEM_TEMPLATE.message, arrInstallingEl);
