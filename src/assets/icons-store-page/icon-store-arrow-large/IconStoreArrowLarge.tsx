import style from "./IconStoreArrowLarge.module.scss";
import { FC, memo } from "react";
const IconStoreArrowLarge: FC = memo(() => {
  return (
    <svg
      width="24"
      height="24"
      ...
      data-v-309d26dc=""
      className={style["icon-store-arrow-large"]}
    >
      <path
...
export default IconStoreArrowLarge;
